...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Luxury China Travels" },
      { property: "og:title", content: "Luxury China Travels — Luxury China Travel from the USA" },
      ...
      { name: "twitter:title", content: "Luxury China Travels — Luxury China Travel from the USA" },
